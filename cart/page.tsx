    ...
    <div style={{ backgroundColor: "white", color: "black", fontFamily: "Arial, sans-serif", minHeight: "100vh" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", gap: "40px" }}>
          ...
          <div style={{ flex: 1, backgroundColor: "#f9f9f9", padding: "20px", borderRadius: "8px" }}>
            ...
            <div>
              ...
              />
              <p style={{ fontSize: "14px" }}>Nike Air Max 97 SE Men's Shoes</p>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '15px' }}>
          <img src="/images/visa.jpg" alt="Visa" className="h-4" />
          <img src="/images/mastercard.jpg" alt="MasterCard" className="h-4"/>
          <img src="/images/upi.jpg" alt="UPI" className="h-4"/>
        </div>
      </footer>
    </div>
  );
